(function (global) {
  ...
  const skills = [
    ...
    { id: 'negatives', title: 'Отрицательные числа', category: 'arithmetic', prerequisites: ['subtraction', 'fractions'], mode: 'arithmetic-negatives' },
    { id: 'expressions', title: 'Простые выражения', category: 'algebra', prerequisites: [], mode: 'equations-missing' },
    ...
    { id: 'equation-multiply', title: 'ax = b', category: 'algebra', prerequisites: ['multiplication'], mode: 'equations-multiplication' },
    { id: 'equation-divide', title: 'x / a = b', category: 'algebra', prerequisites: ['division'], mode: 'equations-division' },
    { id: 'roots', title: 'Квадратные корни', category: 'algebra', prerequisites: ['powers', 'division'], mode: 'algebra-roots' },
    { id: 'equation-two-step', title: 'ax + b = c', category: 'algebra', prerequisites: ['equation-add', 'equation-multiply', 'order-of-operations'], mode: 'equations-two-step' },
    ...
    { id: 'sequences', title: 'Прогрессии', category: 'algebra', prerequisites: ['multiplication', 'equation-two-step', 'order-of-operations'], mode: 'algebra-sequences' },
  ...
  const modeToSkill = {
    ...
    'arithmetic-chain-addition': 'chain-addition', 'arithmetic-parentheses': 'parentheses', 'arithmetic-order': 'order-of-operations', 'arithmetic-negatives': 'negatives',
