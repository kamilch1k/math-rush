(function (global) {
  ...
  const skills = [
    ...
    { id: 'order-of-operations', title: 'Порядок действий', category: 'arithmetic', prerequisites: ['parentheses', 'multiplication', 'division'], mode: 'arithmetic-order' },
    ...
    { id: 'equation-multiply', title: 'ax = b', category: 'algebra', prerequisites: ['multiplication', 'equation-divide', 'equation-add'], mode: 'equations-multiplication' },
