(function (global) {
  ...
  const skills = [
    ...
    { id: 'column-addition', title: 'Сложение в столбик', category: 'arithmetic', prerequisites: ['addition'], mode: 'column-addition' },
    { id: 'column-subtraction', title: 'Вычитание в столбик', category: 'arithmetic', prerequisites: ['subtraction'], mode: 'column-subtraction' },
    ...
    { id: 'chain-addition', title: 'Действия по шагам', category: 'arithmetic', prerequisites: ['addition'], mode: 'arithmetic-chain-addition' },
    { id: 'parentheses', title: 'Скобки', category: 'arithmetic', prerequisites: ['addition', 'division'], mode: 'arithmetic-parentheses' },
    { id: 'order-of-operations', title: 'Порядок действий', category: 'arithmetic', prerequisites: ['parentheses'], mode: 'arithmetic-order' },
    ...
    { id: 'equation-divide', title: 'x / a = b', category: 'algebra', prerequisites: ['division', 'equation-add'], mode: 'equations-division' },
    { id: 'equation-multiply', title: 'ax = b', category: 'algebra', prerequisites: ['multiplication', 'equation-add'], mode: 'equations-multiplication' },
    { id: 'equation-two-step', title: 'ax + b = c', category: 'algebra', prerequisites: ['equation-add', 'equation-multiply'], mode: 'equations-two-step' },
    { id: 'linear-equations', title: 'Линейные уравнения', category: 'algebra', prerequisites: ['equation-two-step', 'equation-divide'], mode: 'equations' },
    ...
    { id: 'powers', title: 'Степени', category: 'algebra', prerequisites: ['multiplication'], mode: 'algebra-powers' },
    { id: 'roots', title: 'Квадратные корни', category: 'algebra', prerequisites: ['powers', 'division'], mode: 'algebra-roots' },
